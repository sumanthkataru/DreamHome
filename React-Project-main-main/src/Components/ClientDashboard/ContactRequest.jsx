                ...
                return (
                    <article key={index} className="mx-auto my-10 flex max-w-md flex-col rounded-2xl bg-white px-4 shadow md:max-w-5xl md:flex-row md:items-center">
                        <div className="py-4 sm:py-8">
                            ...
                            <div>
                                <button className="order-3 mt-4 px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-green-600 transition duration-300" onClick={() => handleAction(message._id, "accepted")}>
                                    Accept
                                </button>
                                <button className="order-3 mt-4 px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-green-600 transition duration-300" onClick={() => handleAction(message._id, "declined")}>
                                    Decline
                                </button>
                                <br></br>
                                <button
